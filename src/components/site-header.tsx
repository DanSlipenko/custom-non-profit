...
export function SiteHeader() {
  return (
    <header className="sticky top-0 z-50 border-b border-zinc-200/70 bg-white/80 hover:bg-white duration-300 backdrop-blur dark:border-zinc-800/70 dark:bg-zinc-950/70">
